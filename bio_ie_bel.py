...
if __name__ == '__main__':
    ...
    options = OptionConfig(model_name='Bert', batch_size=10, epochs=3, bepo=2,
                           ...
                           bld_ent_types=elist, bld_ent_num=0, bld_ent_mode=1, # 0-None, 1-type, 2-typename
                           mark_ent_pair='##@@',  # ''-None, '#@#@', '##@@'
    ...
    main('p', 're', 'BEL', ('train', 'test',), 'ss', tcfg, seed=0, folds=range(1))  # BEL-binary relation
    main('p', 'ure', 'BEL', ('train', 'test',), 'ss', tcfg, seed=0, folds=range(1))  # BEL-binary relation
