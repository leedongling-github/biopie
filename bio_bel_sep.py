...
if __name__ == '__main__':
    ...
    options = OptionConfig(model_name='Bert', batch_size=6, epochs=3,
                           ...
                           mark_ent_pair='##@@', bld_ent_mode=1, #bld_ent_mode 盲化方式对应的名称 0-None, 1-entity type like 'GENE', 2-entity typename like 'chemical'
    ...
    # main('tvp', 'sbel', 'BEL_sep', ('train', 'test'), 'ss', tcfg, bepos=[-1, -1], seed=0, folds=range(5))  # SBEL
    main('tvp', 'sbel', 'BEL_sep', ('train', 'test'), 'ss', tcfg, bepos=[-1, -1], seed=0, folds=range(5))  # SBEL
    main('e', 'sbel', 'BEL_sep', ('train', 'test'), 'ss', tcfg, bepos=[-1, -1], seed=0, folds=range(5))  # SBEL
    # main('e', 'sbel', 'BEL2', ('train', 'test'), 'ss', tcfg, bepos=[-1, -1], folds=range(1))  # SBEL
