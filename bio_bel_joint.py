...
def train_eval_corpus(op, tcfg, task, wdir, cpsfiles, cpsfmts, bepos=None, seed=0, folds=None):
    ...
    # 联合训练模型
        ...
        tcfg.class_weight = np.array([1,1,1,1,1,1,3])
...
if __name__ == '__main__':
    ...
    options = OptionConfig(model_name='Bert', batch_size=6, epochs=3,
                           ...
                           mark_ent_pair='##@@', # why '##@@' not '#@#@'?
                           bld_ent_mode=1, #bld_ent_mode 盲化方式对应的名称 0-None, 1-entity type like 'GENE', 2-entity typename like 'chemical'
    ...
    # main('r', 'sbel', 'BEL_joint', ('train', 'test'), 'ss', tcfg, bepos=[2, 2], seed=0, folds=range(5))  # SBEL
    # main('tvp', 'sbel', 'BEL_joint', ('train', 'test'), 'ss', tcfg, bepos=[2, 2], seed=0, folds=range(5))  # SBEL
    main('tvp', 'sbel', 'BEL_joint', ('train', 'test'), 'ss', tcfg, bepos=[2, 2], seed=0, folds=range(5))  # SBEL
    main('e', 'sbel', 'BEL_joint', ('train', 'test'), 'ss', tcfg, bepos=[2, 2], seed=0, folds=range(5))  # SBEL
